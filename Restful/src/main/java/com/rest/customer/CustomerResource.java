...
public class CustomerResource {
	...
	public Customer getCustomer() {
		...
		if (customer == null)
			throw new RuntimeException("Get: Customer with " + id
					+ " not found");
		return customer;
	}
	...
	public void deleteCustomer() {
		...
		if (c == null)
			throw new RuntimeException("Delete: Customer with " + id
					+ " not found");
	}
	...
	private Response putAndGetResponse(Customer customer) {
		...
		CustomerEnum.instance.getModel().put(customer.getId().toString(),
				customer);
		return res;
	}
