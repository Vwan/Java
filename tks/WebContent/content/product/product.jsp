        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="confirmDeleteModalLabel">Product</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <!-- Description -->
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="Name">Desc</label>
                        <div class="col-md-4">
...
<script src="<%=request.getContextPath() %>/js/dataTables.editor.min.js"></script>
<script src="<%=request.getContextPath() %>/js/bootstrap.min.js"></script>
<script src="<%=request.getContextPath() %>/js/tks/app.js"></script>
<script src="<%=request.getContextPath() %>/js/tks/product.js"></script>
