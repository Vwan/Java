        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- Description -->
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="description">Desc</label>
                        <div class="col-md-4">
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-md-8">
                     ...
                     <div class="col-md-4">
                                    <label class="result"/> <label class="entity-id"/>
                    </div>
                </div>
                 </div>
                </form>
    ...
    <div class="modal fade" id="edit-entity-modal" tabindex="-1" role="dialog" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true"        xmlns="http://www.w3.org/1999/html">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="confirmDeleteModalLabel">Status</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <!-- Description -->
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="edit-description">Desc</label>
                        <div class="col-md-4">
                            <input id="edit-description" name="description" type="text" placeholder="Enter a description" class="form-control input-md" required="">
                            <span class="help-block">Description</span>
                        </div>
                    </div>
                </div>
...
<!-- start: Delete  Modal -->
    ...
    <!-- End Delete modal -->
<!-- New, Edit, Delete and Refresh buttons-->
<div class="col-md-10 col-md-offset-1">
    <div class="panel panel-default panel-table">
        <div class="panel-heading">
            <div class="row">
                <div class="col col-xs-6">
                    <h3 class="text-primary panel-title ">Status List</h3>
                </div>
...
<script src="<%=request.getContextPath() %>/js/tks/actionHandler.js"></script>
    ...
    <script src="<%=request.getContextPath() %>/js/tks/taskstatus.js"></script>
