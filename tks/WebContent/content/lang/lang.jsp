        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="">Languages</h4>
                </div>
                <form id="new-form" role="form" class="form-horizontal" method="post">
                <div class="modal-body">
                    <!-- Name -->
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="langCode">Lang Code</label>
                        <div class="col-md-4">
                            <input id="langCode" name="code" type="text" placeholder="" class="form-control input-md" required="">
                            <span class="help-block">Language Code</span>
                        </div>
                    </div>
                    <!-- Description -->
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="langName">LANG NAME</label>
                        <div class="col-md-4">
                            <input id="langName" name="name" type="text" placeholder="" class="form-control input-md" required="">
                            <span class="help-block">Full name of the language code</span>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="edit-entity-modal" tabindex="-1" role="dialog" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true"        xmlns="http://www.w3.org/1999/html">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="confirmDeleteModalLabel">Languages</h4>
                </div>
                <form id="edit-form" role="form" class="form-horizontal" method="post"><!-- action="/tks/lang/create.action">-->
                <div class="modal-body">
                    <!-- ID -->
                    <div class="form-group">
...
<script src="<%=request.getContextPath() %>/js/tks/language.js"></script>
