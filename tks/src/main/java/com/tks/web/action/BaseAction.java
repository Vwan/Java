...
public abstract class BaseAction<T extends GenericEntity,S extends AbstractGenericService> extends ActionSupport implements Preparable{//implements ModelDriven<T> {
    T entity;
    S service;
    String message;
